                            ...
                            <div class="col-sm-12">
                                <div class="btn-group pull-right m-t-15">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo BASE_URL ?>language/add">Add new language string</a></li>
                                        <li><a href="#" id="regenerate-language">Regenerate language files</a></li>
                                    </ul>
                                </div>
                                <h4 class="page-title">Language Strings</h4>
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo BASE_URL ?>"><?php echo SITE_TITLE ?></a></li>
                                    <li class="active">Language Strings</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary panel-border">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">List of Language Strings</h3>
                                    </div>
