...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Kesedaran</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Apadmedia" name="author" />
    ...
    <body class="authentication-bg">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="mt-4">Proses pemilihan telah ditutup</h3>
                            <p class="text-muted">Keputusan penuh akan diumumkan sebelum mesyuarat ini tamat</p>
                        </div> <!-- end /.text-center-->
        ...
        <footer class="footer footer-alt">
            2019 &copy; E-Voting System <a href="#" class="text-body">Apadmedia</a> 
        </footer>
