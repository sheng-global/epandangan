                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">PBRKL2020/DRAF/<?php echo $data[0]['borang_id'] ?></li>
                                </ol>
                            </div>
                            <h4 class="page-title">PBRKL2020/DRAF/<?php echo $data[0]['borang_id'] ?></h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="card-box ribbon-box">
                            ...
                            <h4 class="header-title">Bahagian A: Pandangan anda terhadap Draf PBRKL 2040</h4>
